...
from foodie.orders.views import OrderViewSet, UnassignedOrderViewSet, ActiveOrderViewSet, DeliveredOrderViewSet
...
router.register(r'orders/delivered', DeliveredOrderViewSet, 'orders/delivered')
